...
- Core Architecture & Pipeline: server/index.ts, server/routes.ts, server/types.d.ts, server/constants.ts, server/routes/pipeline.ts, server/routes/utils.ts, server/routes/calls.ts, server/routes/calls-tags.ts, server/routes/employees.ts, server/routes/admin.ts, server/routes/admin-operations.ts, server/routes/admin-content.ts, server/middleware/waf.ts, server/middleware/rate-limit.ts, server/middleware/error-handler.ts, server/services/job-queue.ts, server/services/websocket.ts, server/services/logger.ts, server/services/correlation-id.ts, server/services/tracing.ts, server/services/trace-span.ts, server/services/sentry.ts
