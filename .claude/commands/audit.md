...
Core Architecture & Pipeline: server/index.ts, server/routes.ts, server/routes/pipeline.ts, server/routes/utils.ts, server/routes/config.ts, server/middleware/waf.ts, server/middleware/rate-limit.ts, server/middleware/error-handler.ts, server/types.d.ts, server/services/job-queue.ts, server/services/websocket.ts, server/services/correlation-id.ts, server/services/logger.ts, server/services/tracing.ts, server/services/trace-span.ts
...
Frontend / UI: client/src/App.tsx, client/src/pages/, client/src/components/, client/src/lib/queryClient.ts, client/src/lib/i18n.ts, client/src/lib/sentry.ts, client/src/lib/constants.ts, client/src/lib/safe-storage.ts, client/src/lib/transcript-search.ts, client/src/hooks/
